...
Version  : 0.9.5
Release  : 31
URL      : https://files.pythonhosted.org/packages/e2/d0/b770e5d47794323f06dab98c328c6d25758f4aca015017e709af3d1abee2/pytest-sugar-0.9.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/e2/d0/b770e5d47794323f06dab98c328c6d25758f4aca015017e709af3d1abee2/pytest-sugar-0.9.5.tar.gz
...
%prep
%setup -q -n pytest-sugar-0.9.5
cd %{_builddir}/pytest-sugar-0.9.5
pushd ..
cp -a pytest-sugar-0.9.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657555446
...
cp %{_builddir}/pytest-sugar-0.9.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pytest_sugar/ddb1f9409837a9415697b56693032fc8dd25d287
